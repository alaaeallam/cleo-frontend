          ...
          {data.map((category, i) => (
            <li className="group" key={i + 1}>
              <div
                ...
                className="flex w-full h-full border-2 rounded-lg border-gray-100 shadow-sm bg-white p-4 cursor-pointer transition duration-200 ease-linear transform group-hover:shadow-lg"
              >
